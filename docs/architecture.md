...
The high-level API (`ESMFold`, `ESM2`, `ESMC`, `ESMFold2`, `Chai1`, and `Boltz2`) is a thin wrapper around two building blocks:

- **Core algorithms** (`ESMFoldCore`, `ESM2Core`, `ESMCCore`) encapsulate all model-specific logic. They know nothing about Modal, which keeps the code portable.
