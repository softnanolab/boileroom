...
class LocalBackend(Backend):
    ...
    def __init__(
        ...
        *,
        ...
        ----------
        model_cls : Type[Any]
            The model class to instantiate when the backend starts.
        config : dict | None
            Optional configuration mapping; a shallow copy is stored for backend use.
        device : str | None
            Optional device identifier; if provided, it is set into the stored config under the key "device" unless already present.
        """
        super().__init__()
    ...
    def get_model(self) -> Any:
        ...
        ------
        RuntimeError
            If no model has been started; call start() first.
        """
        if self._model is None:
    ...
    def _instantiate_model(self) -> Any:
        ...
        -------
        Any
            An instance of the configured model class constructed with the backend's config.
        """
    ...
    def _initialize_model(self, model: Any) -> None:
        ...
        ----------
        model : Any
            The model instance to initialize.
        """
