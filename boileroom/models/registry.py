...
ESMC_IMAGE_NAME = get_model_image_spec("esmc").image_name
...
ESMC_SPEC = ModelSpec(
    ...
    public_name="ESMC",
    family="esmc",
    wrapper_class_path="boileroom.models.esmc.esmc.ESMC",
    modal_class_path="boileroom.models.esmc.esmc.ModalESMC",
    apptainer_core_class_path="boileroom.models.esmc.core.ESMCCore",
    apptainer_image_name=ESMC_IMAGE_NAME,
    supported_backends=("modal", "apptainer"),
    contract=ModelContract(
        task_method="embed",
        task_kind="embedding",
...
MODEL_SPECS = (ESMFOLD_SPEC, ESM2_SPEC, ESMFOLD2_SPEC, ESMC_SPEC, CHAI1_SPEC, BOLTZ2_SPEC)
