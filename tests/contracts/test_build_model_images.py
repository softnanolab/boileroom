...
def test_main_skips_existing_base_and_model_tags(monkeypatch: MonkeyPatch, tmp_path: Path) -> None:
    ...
    assert built_tasks == [
        ...
        ("boileroom-esmc", f"docker.io/jakublala/boileroom-base:cuda{DEFAULT_CUDA_VERSION}-sha-test"),
    ...
    assert checked_refs == [
        ...
        f"docker.io/jakublala/boileroom-esmc:cuda{DEFAULT_CUDA_VERSION}-sha-test",
